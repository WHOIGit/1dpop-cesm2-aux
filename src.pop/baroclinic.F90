...
! Modified by Ivan Lima on Fri Mar 12 2021 08:20:44 -0700
...
!-----------------------------------------------------------------------
!   add U & V restoring terms - Ivan Lima - present location
!-----------------------------------------------------------------------
      ...
      do k = 1,km
         ...
         ! ! U, V restoring diagnostics
         ! call accumulate_tavg_field(UVEL(:,:,k,newtime,iblock),tavg_UVEL6,iblock,k)
         ! call accumulate_tavg_field(VVEL(:,:,k,newtime,iblock),tavg_VVEL6,iblock,k)
      enddo
...
!-----------------------------------------------------------------------
   ...
   ! add G-term forcing for U and U - Ivan Lima
...
!-----------------------------------------------------------------------
   ...
   ! add G-term forcing for T and S - Ivan Lima
   if (lsingle_col_force_f1d) then
